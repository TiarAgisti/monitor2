...
var Main = function() {
	...
	var copyright = '&copy; <span class="current-year">'+(new Date).getFullYear()+'</span><span class="text-bold text-uppercase"> IT PBT</span>. <span>All rights reserved</span>';
	...
	var settingsHandler = function() {
		...
		$('.sidebar-toggler').on('click', function(){
			app.hasClass("app-sidebar-closed") ? appSetting.closedSidebar = false : appSetting.closedSidebar = true;
	...
	var runLogout = function(){
		$('.btn-logout').on('click',function(){
			$.post(host+'/ajax/logout', function(data, textStatus, xhr) {
				if (!textStatus) {
